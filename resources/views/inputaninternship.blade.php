                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header text-center">
                                <strong>
                                    <h3>Input Intership</h3>
                                </strong>
                            </div>
                            <form action="/inputinternship/inputaninternship/tambahinputinternship" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="judul1" placeholder="Enter Judul 1" required="required">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="konten5" placeholder="Enter Konten 5" required="required">
                                </div>
